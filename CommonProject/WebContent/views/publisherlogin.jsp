...
button:hover {
	background: linear-gradient(to bottom, rgba(107, 198, 186, 1) 0%,
		rgba(57, 175, 154, 1) 100%);
}

button:active {
	box-shadow: inset 0 0 5px #000;
	background: linear-gradient(to bottom, rgba(57, 175, 154, 1) 0%,
...
.io img {
	width: 150px;
	border-radius: 100%;
	border: 4px solid margin-top:    10px;
...
<body background="resources/background.jpg">
	...
	<div class="login">
		<h1>Login as publisher.</h1>
		<form action="PubLogin" method="POST" autocomplete="off">

			<div class="input">
				<div class="blockinput">
					<i class="icon-envelope-alt"></i><input type="text"
						placeholder="Publisher name" name="username">
				</div>
				<div class="blockinput">
					<i class="icon-unlock"></i><input type="password"
