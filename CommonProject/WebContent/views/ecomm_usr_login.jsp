...
<body bgcolor="gray">
	<div align="center">
		...
		<div class="login">
			...
			<form name="loginform" action="UsersLogin"
				...
				<div class="input">
					...
					<div class="blockinput">
						<i class="icon-unlock"></i><input type="password" name="password"
		...
		<p>
		<p>
			<a href="Welcome">Go to your account </a>
		<p>
