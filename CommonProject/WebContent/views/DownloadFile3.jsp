...
String filePath;
{
	...
	//ServletContext: This represent the compete web application within a JVM. Typical web app containing servlets, JSPs, beans etc., run inside a single context called servlet context - a virtual wrapper. 
	//All application components can get their initialisation parameters, application attributes etc., from this object.
